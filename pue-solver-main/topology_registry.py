...
TOPOLOGY_REGISTRY = {
    "acc_gas_engine_cdu": {
        ...
        "power_source_options": ["Gas Engine"],
        "equipment_ids": [
            "acc_unit",
            "cdu",
            "pump",
    ...
    "chiller_dry_cooler": {
        ...
        "implementation_status": "framework_ready_data_missing",
        "calculation_status": "framework_ready_data_missing",
        ...
        "report_profile": "generic_chiller_dry_cooler",
        "notes": "Standard annual chiller/dry-cooler scaffolding exists, but the Configuration Library direct path and manufacturer data bindings are incomplete.",
