...
TOPOLOGY_REGISTRY = {
    ...
    "chiller_dry_cooler": {
        ...
        "notes": "Configuration Library framework package exists; annual simulation requires validated manufacturer Solver_Curve data and solver module implementation.",
