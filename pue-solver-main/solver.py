...
def compute_pue_project(input_obj):
    ...
    for i in range(n):
        ...
        result["hourly_results"].append({
            ...
            "CHW_pump_power_kW": chw_pump_power_per_unit_kw * pump_active_unit_count,
            "CW_pump_power_kW": cw_pump_power_per_unit_kw * pump_active_unit_count,
        ...
        if design_it_load_source is not None and design_it_load_source > 0 and peak_design_ambient_c is None:
            ...
            try:
                ...
                result["peak_results"].update({
                    ...
                    "peak_design_CHW_pump_power_kW": peak_design_hour.get("CHW_pump_power_kW"),
                    "peak_design_CW_pump_power_kW": peak_design_hour.get("CW_pump_power_kW"),
                    "peak_design_dry_cooler_power_kW": peak_design_hour.get("dry_cooler_power_kW"),
